...
urlpatterns = [
	...
	url(r'^list-article-titles/$', list_views.article_title, name="article_titles"),
	url(r'^list-article-detail/(?P<id>\d+)/(?P<slug>[-\w]+)/$', list_views.article_detail, name="list_article_detail"),
	url(r'^list-article-titles/(?P<username>[-\w]+)/$', list_views.article_title, name="author_articles"),
